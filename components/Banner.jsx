    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mt-6 w-full max-w-187"
        >
          <TypeAnimation
            splitter={(str) => str.split(/(?= )/)}
            sequence={[
              "Building scalable, high-performance web applications using React, Next.js, Node.js, and modern databases. Focused on clean architecture, efficient APIs, and delivering seamless user experiences across both frontend and backend.",
              5000,
            ]}
